...
## Natija
<video src="https://github.com/devbexruz/dangasa_control/raw/main/Result.mp4" width="100%" controls></video>


## Xususiyatlari

✨ **Ko'z Qimiriltishini Aniqlash** - Ko'z qimiriltish orqali videolarni o'chirish/yoqish  
👋 **Qo'l Harakatlari Tanish** - Qo'l harakatlari orqali videolar orasida harakatlanish  
📹 **Video Tasviri** - Gestura asosidagi boshqaruv bilan silliq video ishi  
🎯 **Real Vaqtda Qayta Ishlash** - Tez va aniq gesture aniqlash  
...
└── Result.mp4       # Dasturning ishlashini ko'rsatuvchi video
```
